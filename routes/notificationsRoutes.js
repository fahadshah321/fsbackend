...
class UniversalEmailService {
  ...
  async sendViaResendAPI(options) {
    try {
      ...
      if (typeof options.from === 'object') {
        ...
        const defaultFrom = process.env.EMAIL_FROM || 'noreply@fundssmartphones.de';
  ...
  async sendEmail(mailOptions) {
    ...
    let defaultFrom;
    const emailFrom = process.env.EMAIL_FROM || process.env.EMAIL_USER || process.env.SMTP_USER || 'noreply@fundssmartphones.de';
